...
import { createMockServerAdapter, generateAccounts } from './accountMockServerAdapter'
...
describe('account example mock server adapter', () => {
  it('generates account-shaped rows for the dashboard example', () => {
  ...
  it('applies account demo filtering, sorting, and pagination', async () => {
